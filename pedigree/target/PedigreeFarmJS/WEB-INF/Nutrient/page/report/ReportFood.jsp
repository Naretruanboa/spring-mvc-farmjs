...
<title>ออกรายงานการจัดสัดส่วนอาหาร</title>
				...
				<div class="form-inline">
					<div class="col-md-3">
						<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
							align="center">
							<p style="font-size: 26px; font-weight: 700; color: white;">ออกรายงานการจัดสัดส่วนอาหาร</p>
						</div>
					</div>
					<div class="col-md-9" align="right">
						...
						<span class="input-group-btn search-query"> <select class="form-control  search-query btn-info" id="sel" style="width: 150px;color: white;">								
								<option value="1">จัดสัดส่วนโคเนื้อ</option>	
								<option value="2">จัดสัดส่วนโคนม</option>						
...
<div class="panel panel-primary">
		<div class="panel-heading">
	        <h4 class="panel-title" style="font-size: 25px;">ออกรายงานการจัดสัดส่วนอาหาร</h4>
	   	</div>

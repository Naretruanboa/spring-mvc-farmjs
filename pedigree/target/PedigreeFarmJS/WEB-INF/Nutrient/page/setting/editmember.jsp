...
<div class="panel panel-primary">
		...
		<form:form action="register" method="post" commandName="memberedit" id="member">
	...
	<tr>
		...
		<td class="text-center"><form:input id="birthday" path="birthday" class="form-control date" placeholder="ปปปป/ดด/วว" /></td>
	</tr>
	<tr>
			...
			$.ajax({
				...
				swal({  title: "สำเร็จ",   
					text: "บันทึกเรียบร้อยแล้ว!", 
						...
						function(){   
							window.location.href='SetMember'; 
							});

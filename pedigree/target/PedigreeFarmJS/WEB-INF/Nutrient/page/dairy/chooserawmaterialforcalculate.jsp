...
<head>
<meta charset="utf-8">
<title>เลือกวัตถุดิบอาหารข้นราคาต่ำสุด</title>
</head>
<body>
		 ...
		 <div class=" row form-group">
					<div class="col-md-5" >
						<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
							align="center">
							<p style="font-size: 28px; font-weight: 700; color: white;">เลือกวัตถุดิบเพื่อจัดสัดส่วนอาหารข้นราคาต่ำสุด</p>
						</div>
					</div>
			</div>
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title" style="font-size: 24px; color: white;">
							<!-- <i class="fa fa-cart-arrow-down"></i> -->&nbsp;อาหารข้น
						</h3>
					</div>
					<div class="panel-body">
						<div class="row form-group">
						...
						<div class="row form-group">
							<div class="col-md-offset-5 col-md-12">
								<button type="button" class="btn btn-default btn-lg" id="cen" onclick="cen()">
									<a href="setrawmateriallowcostdairy">ตกลง
								</button>
							</div>

								...
								<center>
									<div class="row form-group">
										...
										border="0" bordercolor="#BDBDBD"  >
											...
											<tr >
												<th><input id="dyWeight" name="dyWeight" size="10" value="${cattledetail.weight}" disabled="true" ></th>
												<th><input size="10" value="${cattledetail.wpD}" disabled="true"></th>
												<th><input size="10" value="${cattledetail.age}" disabled="true"></th>
												<th><input size="10" value="${cattledetail.pregnant}" disabled="true"></th>
...
$(document).on('click','#addcalformula',function(e){ //id of button
	...
	if(sol1==""){
		...
		/* console.log("${cattledetail.weight} :",$('#dyWeight').val()); */
		console.log("data : ",$("#rawmaterialprice").serialize());
		$.ajax({

...
<body>
<header class="header"> <nav class="navbar navbar-default navbar-fixed-top">
...
<c:if test="${sessionScope.privilege != null}">
        ...
        <li class="dropdown">
            <a href="pedigree" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>&nbsp;${m.first}<b class="caret"></b></a>
